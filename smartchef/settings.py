...
load_dotenv() # .env dosyasındaki gizli şifreleri sisteme yükler
...
SECRET_KEY = 'django-insecure-vxi9sjum!6s&$9aniswze@n1r^eb1@n&76@(*zp-jh=zjgq)$z'
...
STATIC_URL = 'static/'
# --- GERÇEK E-POSTA GÖNDERME AYARLARI (SMTP) ---
